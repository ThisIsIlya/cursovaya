                            ...
                            <div class="col-12">
                                <div class="tab-content" id="pills-tabContent">
                                    <div class="tab-pane fade show active" id="pills-grid" role="tabpanel"
                                        ...
                                        <div class="row">
                                            <div v-for="cathalog in cathalogs" class="col-xl-4 col-lg-6 col-6 ">
                                                <div class="products-three-single w-100  mt-30">
                                                        ...
                                                        <div class="products-grid__usefull-links">
                                                            <ul>
                                                                ...
                                                                <li><a href="compare.html"> <i
                                                                        ...
                                                                        <span>
                                                                            compare</span> </a> </li>
                                                                <li><a :href="`#popup5${{cathalog.id}}`" class="popup_link"> <i
                                                    ...
                                                    <div :id="`popup5${{cathalog.id}}`" class="product-gird__quick-view-popup mfp-hide">
                                                        <div class="container">
                                                                    ...
                                                                    <div class="popup-right-content">
                                                                        ...
                                                                        <div class="ratting"> <i
                                                                            ...
                                                                            <i class="flaticon-star"></i> <i
                                                                                class="flaticon-star"></i>
                                                                            <span>(112)</span> </div>
                                                                        <p class="text"> {{cathalog.Catalog_size}}
                                                                        </p>
                                                                        <div class="price">
                                                                            <h2> ${{cathalog.Catalog_price}} USD <del> $65 USD</del></h2>
                                                                            <h6> In stuck</h6>
                                                                        </div>
                                                    ...
                                                    <div class="products-three-single-content text-center"> <span>cathalog.Catalog_matherial</span>
                                                        <h5><a href="shop-details-3.html"> {{cathalog.Catalog_type}} </a>
                                                        </h5>
                                                        <p><del>$200.00</del>$ {{cathalog.Catalog_price}}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
export default {
    ...
    methods:{
        getCathalogs(){
            this.axios.get('http://127.0.0.1:8000/api/cathalogs/home')
            .then(res => {
                console.log(res);
            })
            .finally(v => {
